; (function (VIS, $) {
    ...
    function AProcess(AD_Process_ID, height, splitUI, extrnalForm) {
        ...
        if (this.splitUI) {
            this.partitionContainer = $('<div>');
            this.parameterContainer = $('<div style="">');
            this.reportContainer = $('<div style="">');
            this.reportToolbar = $('<div style="">');
        ...
        this.onclickTrigger = function (self) {
            ...
            if (self.splitUI) {
                self.parent.getContentGrid().empty();
                self.parent.getContentGrid().append(self.partitionContainer);
            }
            ctl = null;
        };
    ...
    AProcess.prototype.createUI = function (panel, pctl, repObj) {
        ...
        function createControls(panel, repObj) {
            ...
            btnSaveCsvAll = $("<li><a  title='" + VIS.Msg.getMsg("SaveAllRecordCsv") + "'  style='cursor:pointer;'class='" + self.cssForAll + " vis-savecsvAll-ico vis-report-icon'></a></li>");
            btnsavepdfall = $("<li><a  title='" + VIS.Msg.getMsg("SaveAllPagePdf") + "' style='cursor:pointer;' class='" + self.cssForAll + " vis-savepdfALL-ico vis-report-icon'></a></li>");
