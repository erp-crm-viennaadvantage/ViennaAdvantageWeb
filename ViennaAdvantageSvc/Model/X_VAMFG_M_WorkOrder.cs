namespace ViennaAdvantage.Model
{
    ...
    {
        public X_VAMFG_M_WorkOrder(Context ctx, int VAMFG_M_WorkOrder_ID, Trx trxName)
            : base(ctx, VAMFG_M_WorkOrder_ID, trxName)
        {
        ...
        public X_VAMFG_M_WorkOrder(Ctx ctx, int VAMFG_M_WorkOrder_ID, Trx trxName)
            : base(ctx, VAMFG_M_WorkOrder_ID, trxName)
        {
            /** if (VAMFG_M_WorkOrder_ID == 0)
            {
        ...
        */
        public X_VAMFG_M_WorkOrder(Context ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        /** Load Constructor 
        ...
        @param trxName transaction
        */
        public X_VAMFG_M_WorkOrder(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        /** Load Constructor 
        ...
        @param trxName transaction
        */
        public X_VAMFG_M_WorkOrder(Ctx ctx, IDataReader dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
        /** Static Constructor 
        ...
        */
        ...
        /** Set Plan Run.
        @param VAMRP_PlanRun_ID Plan */
        public void SetVAMRP_PlanRun_ID(int VAMRP_PlanRun_ID)
        {
            if (VAMRP_PlanRun_ID < 1) throw new ArgumentException("VAMRP_PlanRun_ID is mandatory.");
            Set_ValueNoCheck("VAMRP_PlanRun_ID", VAMRP_PlanRun_ID);
        }
        /** Get Plan Run.
        @return Plan Run*/
        public int GetVAMRP_PlanRun_ID()
        {
            Object ii = Get_Value("VAMRP_PlanRun_ID");
            if (ii == null) return 0;
            return Convert.ToInt32(ii);
        }
        ...
        { if (GOM01_Density == null) throw new ArgumentException("GOM01_Density is mandatory."); Set_Value("GOM01_Density", (Decimal?)GOM01_Density); }
        /** Get Density.
        @return Density */
