...
namespace ViennaAdvantage.Model
{
    public class MJournal : X_GL_Journal, DocAction
    {
               ...
               String newC_Period_ID, int windowNo)
        {
            ...
            int C_Period_ID = Util.GetValueOfInt(newC_Period_ID);
            if (C_Period_ID == 0)
            {
                return;
            }
               ...
               String newC_ConversionType_ID, int windowNo)
        {
            ...
            int C_ConversionType_ID = Util.GetValueOfInt(newC_ConversionType_ID);
            if (C_ConversionType_ID == 0)
            {
                return;
            }
        ...
        private Boolean UpdateBatch()
        {
            ...
            int nooo = Util.GetValueOfInt(DB.ExecuteScalar(sqlquery, null, null));
            if (nooo == null || nooo <= 0)
            {
                return true;
            }
