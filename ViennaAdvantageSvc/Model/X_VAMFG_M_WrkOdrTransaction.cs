namespace ViennaAdvantage.Model
{
    ...
    {
        public X_VAMFG_M_WrkOdrTransaction(Context ctx, int VAMFG_M_WrkOdrTransaction_ID, Trx trxName)
            : base(ctx, VAMFG_M_WrkOdrTransaction_ID, trxName)
        {
        ...
        public X_VAMFG_M_WrkOdrTransaction(Ctx ctx, int VAMFG_M_WrkOdrTransaction_ID, Trx trxName)
            : base(ctx, VAMFG_M_WrkOdrTransaction_ID, trxName)
        {
            /** if (VAMFG_M_WrkOdrTransaction_ID == 0)
            {
        ...
        */
        public X_VAMFG_M_WrkOdrTransaction(Context ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        /** Load Constructor 
        ...
        @param trxName transaction
        */
        public X_VAMFG_M_WrkOdrTransaction(Ctx ctx, DataRow rs, Trx trxName)
            : base(ctx, rs, trxName)
        {
        }
        /** Load Constructor 
        ...
        @param trxName transaction
        */
        public X_VAMFG_M_WrkOdrTransaction(Ctx ctx, IDataReader dr, Trx trxName)
            : base(ctx, dr, trxName)
        {
        }
        /** Static Constructor 
        ...
        */
        ...
        /** Set Operation End Date.
        @param GOM01_OperationEndDate Operation End Date */
        public void SetGOM01_OperationEndDate(DateTime? GOM01_OperationEndDate) { Set_Value("GOM01_OperationEndDate", (DateTime?)GOM01_OperationEndDate); }
        /** Get Operation End Date.@return Operation End Date */
        public DateTime? GetGOM01_OperationEndDate() { return (DateTime?)Get_Value("GOM01_OperationEndDate"); }
        /** Set Operation Start Date.@param GOM01_OperationStartDate Operation Start Date */
        public void SetGOM01_OperationStartDate(DateTime? GOM01_OperationStartDate) { Set_Value("GOM01_OperationStartDate", (DateTime?)GOM01_OperationStartDate); }
        /** Get Operation Start Date.@return Operation Start Date */
        public DateTime? GetGOM01_OperationStartDate() { return (DateTime?)Get_Value("GOM01_OperationStartDate"); }
        /** Set Batch No.
        @param GOM01_BatchNo Batch No */
        public void SetGOM01_BatchNo(String GOM01_BatchNo)
        {
            if (GOM01_BatchNo != null && GOM01_BatchNo.Length > 14)
            {
                log.Warning("Length > 14 - truncated"); GOM01_BatchNo = GOM01_BatchNo.Substring(0, 14);
            }
            Set_Value("GOM01_BatchNo", GOM01_BatchNo);
        }
        /** Get Batch No.
        @return Batch No */
        public String GetGOM01_BatchNo()
        {
            return (String)Get_Value("GOM01_BatchNo");
        }
        /** Set Density.
        @param GOM01_Density Density */
        public void SetGOM01_Density(Decimal? GOM01_Density)
        {
            Set_Value("GOM01_Density", (Decimal?)GOM01_Density);
        }
        /** Get Density.
        @return Density */
        public Decimal GetGOM01_Density()
        {
            Object bd = Get_Value("GOM01_Density"); if (bd == null) return Env.ZERO; return Convert.ToDecimal(bd);
        }
        /** Set Quantity.
        @param GOM01_Quantity Quantity */
        public void SetGOM01_Quantity(Decimal? GOM01_Quantity)
        {
            Set_Value("GOM01_Quantity", (Decimal?)GOM01_Quantity);
        }
        /** Get Quantity.
        @return Quantity */
        public Decimal GetGOM01_Quantity()
        {
            Object bd = Get_Value("GOM01_Quantity"); if (bd == null) return Env.ZERO; return Convert.ToDecimal(bd);
        }
        /** Set Actual Density.
@param GOM01_ActualDensity Actual Density */
        public void SetGOM01_ActualDensity(Decimal? GOM01_ActualDensity)
        {
            Set_Value("GOM01_ActualDensity", (Decimal?)GOM01_ActualDensity);
        }
        /** Get Actual Density.
@return Actual Density */
        public Decimal GetGOM01_ActualDensity()
        {
            Object bd = Get_Value("GOM01_ActualDensity"); if (bd == null) return Env.ZERO; return Convert.ToDecimal(bd);
        }
        /** Set Actual Quantity (In Liters).
@param GOM01_ActualLiter Actual Quantity (In Liters) */
        public void SetGOM01_ActualLiter(Decimal? GOM01_ActualLiter)
        {
            Set_Value("GOM01_ActualLiter", (Decimal?)GOM01_ActualLiter);
        }
        /** Get Actual Quantity (In Liters).
@return Actual Quantity (In Liters) */
        public Decimal GetGOM01_ActualLiter()
        {
            Object bd = Get_Value("GOM01_ActualLiter"); if (bd == null) return Env.ZERO; return Convert.ToDecimal(bd);
        }
        /** Set Actual Quantity (In KG).
@param GOM01_ActualQuantity Actual Quantity (In KG) */
        public void SetGOM01_ActualQuantity(Decimal? GOM01_ActualQuantity)
        {
            Set_Value("GOM01_ActualQuantity", (Decimal?)GOM01_ActualQuantity);
        }
        /** Get Actual Quantity (In KG).
@return Actual Quantity (In KG) */
        public Decimal GetGOM01_ActualQuantity()
        {
            Object bd = Get_Value("GOM01_ActualQuantity"); if (bd == null) return Env.ZERO; return Convert.ToDecimal(bd);
        }
        ...
        /** ConsiderReservedQty AD_Reference_ID=1000611 */
        public static int CONSIDERRESERVEDQTY_AD_Reference_ID = 1000611;/** No = N */
        public static String CONSIDERRESERVEDQTY_No = "N";/** Yes = Y */
        public static String CONSIDERRESERVEDQTY_Yes = "Y";/** Is test a valid value.
@param test testvalue
@returns true if valid **/
        public bool IsConsiderReservedQtyValid(String test) { return test == null || test.Equals("N") || test.Equals("Y"); }/** Set Consider Reserved Qty.
@param ConsiderReservedQty It indicate whether the reserved qty to be used for checking quantity availability in the warehouse or not. */
        public void SetConsiderReservedQty(String ConsiderReservedQty)
        {
            if (!IsConsiderReservedQtyValid(ConsiderReservedQty))
                throw new ArgumentException("ConsiderReservedQty Invalid value - " + ConsiderReservedQty + " - Reference_ID=1000611 - N - Y"); if (ConsiderReservedQty != null && ConsiderReservedQty.Length > 1) { log.Warning("Length > 1 - truncated"); ConsiderReservedQty = ConsiderReservedQty.Substring(0, 1); } Set_Value("ConsiderReservedQty", ConsiderReservedQty);
        }/** Get Consider Reserved Qty.
@return It indicate whether the reserved qty to be used for checking quantity availability in the warehouse or not. */
        public String GetConsiderReservedQty() { return (String)Get_Value("ConsiderReservedQty"); }
