...
*/
 ...
 added by ->Harwinder */
        ...
        static long serialVersionUID = 27816976355670L;/** Last Updated Timestamp 8/21/2018 5:00:38 PM */
        public static long updatedMS = 1534851038881L;/** AD_Table_ID=335 */
...
@return Account Number */
        public String GetAccountNo() { return (String)Get_Value("AccountNo"); }/** Set As on Date.
@param AsOnDate As on Date */
        public void SetAsOnDate(DateTime? AsOnDate) { Set_Value("AsOnDate", (DateTime?)AsOnDate); }/** Get As on Date.
@return As on Date */
        public DateTime? GetAsOnDate() { return (DateTime?)Get_Value("AsOnDate"); }/** Set Activity.
...
@return Payment identifier */
        ...
        /** C_ProjectRef_ID AD_Reference_ID=1000161 */
        public static int C_PROJECTREF_ID_AD_Reference_ID = 1000161;/** Set Project.
...
@return Tax identifier */
        public int GetC_Tax_ID() { Object ii = Get_Value("C_Tax_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }/** Set Charge amount.
...
@return Credit Card (Visa, MC, AmEx) */
        public String GetCreditCardType() { return (String)Get_Value("CreditCardType"); }/** Set DraftDate.
...
@return Export */
        public String GetExport_ID() { return (String)Get_Value("Export_ID"); }/** Set Multi Charges/Invoices.
@param INT13_IsMultiCharge Multi Charges/Invoices */
        public void SetINT13_IsMultiCharge(Boolean INT13_IsMultiCharge) { Set_Value("INT13_IsMultiCharge", INT13_IsMultiCharge); }/** Get Multi Charges/Invoices.
@return Multi Charges/Invoices */
        public Boolean IsINT13_IsMultiCharge() { Object oo = Get_Value("INT13_IsMultiCharge"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set Indemnity Avail Days.
...
@return Charge after Shipment */
        public Boolean IsDelayedCapture() { Object oo = Get_Value("IsDelayedCapture"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set In Dispute.
...
@return Document is in dispute */
        public Boolean IsInDispute() { Object oo = Get_Value("IsInDispute"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set Online Access.
...
@return Can be accessed online  */
        public Boolean IsOnline() { Object oo = Get_Value("IsOnline"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set IsOpeningPayment.
@param IsOpeningPayment IsOpeningPayment */
        public void SetIsOpeningPayment(Boolean IsOpeningPayment) { Set_Value("IsOpeningPayment", IsOpeningPayment); }/** Get IsOpeningPayment.
@return IsOpeningPayment */
        public Boolean IsOpeningPayment() { Object oo = Get_Value("IsOpeningPayment"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set Over/Under Payment.
...
@return Over-Payment (unallocated) or Under-Payment (partial payment) */
        public Boolean IsOverUnderPayment() { Object oo = Get_Value("IsOverUnderPayment"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set Payment Allocate.
@param IsPaymentAllocate To specify that is there are records on Payment Allocate tab. */
        public void SetIsPaymentAllocate(Boolean IsPaymentAllocate) { Set_Value("IsPaymentAllocate", IsPaymentAllocate); }/** Get Payment Allocate.
@return To specify that is there are records on Payment Allocate tab. */
        public Boolean IsPaymentAllocate() { Object oo = Get_Value("IsPaymentAllocate"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set Prepayment.
...
@return Original Transaction ID */
        public String GetOrig_TrxID() { return (String)Get_Value("Orig_TrxID"); }/** Set Outstanding Amount.
@param OutStandingAmount Outstanding Amount */
        public void SetOutStandingAmount(String OutStandingAmount) { if (OutStandingAmount != null && OutStandingAmount.Length > 500) { log.Warning("Length > 500 - truncated"); OutStandingAmount = OutStandingAmount.Substring(0, 500); } Set_ValueNoCheck("OutStandingAmount", OutStandingAmount); }/** Get Outstanding Amount.
@return Outstanding Amount */
        public String GetOutStandingAmount() { return (String)Get_Value("OutStandingAmount"); }/** Set Over/Under Payment.
...
@return Over-Payment (unallocated) or Under-Payment (partial payment) Amount */
        ...
        /** PDCType AD_Reference_ID=1000292 */
        public static int PDCTYPE_AD_Reference_ID = 1000292;/** Direct PDC = D */
...
@param PDCType PDC Type */
        public void SetPDCType(String PDCType)
        {
            if (!IsPDCTypeValid(PDCType))
                throw new ArgumentException("PDCType Invalid value - " + PDCType + " - Reference_ID=1000292 - D - N"); if (PDCType != null && PDCType.Length > 1) { log.Warning("Length > 1 - truncated"); PDCType = PDCType.Substring(0, 1); } Set_Value("PDCType", PDCType);
        }/** Get PDC Type.
@return PDC Type */
        public String GetPDCType() { return (String)Get_Value("PDCType"); }/** Set PO Number.
...
@return Track 1 and 2 of the Credit Card */
        public String GetSwipe() { return (String)Get_Value("Swipe"); }/** Set TaxAmount.
...
@return This tax amount is updated on charge selection */
        public Decimal GetTaxAmount() { Object bd = Get_Value("TaxAmount"); if (bd == null) return Env.ZERO; return Convert.ToDecimal(bd); }/** Set Tax Amount.
...
@return Tax Amount for a document */
        ...
        public static String TENDERTYPE_Check = "K";/** Letter of Credit = L */
        public static String TENDERTYPE_LetterOfCredit = "L";/** Is test a valid value.
@param test testvalue
@returns true if valid **/
        public bool IsTenderTypeValid(String test) { return test.Equals("A") || test.Equals("C") || test.Equals("D") || test.Equals("K") || test.Equals("L"); }/** Set Tender type.
@param TenderType Method of Payment */
        public void SetTenderType(String TenderType)
        {
            if (TenderType == null) throw new ArgumentException("TenderType is mandatory"); if (!IsTenderTypeValid(TenderType))
                throw new ArgumentException("TenderType Invalid value - " + TenderType + " - Reference_ID=214 - A - C - D - K - L"); if (TenderType.Length > 1) { log.Warning("Length > 1 - truncated"); TenderType = TenderType.Substring(0, 1); } Set_Value("TenderType", TenderType);
        }/** Get Tender type.
@return Method of Payment */
        public String GetTenderType() { return (String)Get_Value("TenderType"); }/** Set Trx No..
@param TrxNo Card, Cheque and Other online transaction number */
        public void SetTrxNo(String TrxNo) { if (TrxNo != null && TrxNo.Length > 30) { log.Warning("Length > 30 - truncated"); TrxNo = TrxNo.Substring(0, 30); } Set_Value("TrxNo", TrxNo); }/** Get Trx No..
@return Card, Cheque and Other online transaction number */
        public String GetTrxNo() { return (String)Get_Value("TrxNo"); }
...
@return User defined list element #2 */
        public int GetUser2_ID() { Object ii = Get_Value("User2_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }/** Set Cancel Check.
...
@return Cancel Check */
        ...
        /** VA009_ExecutionStatus AD_Reference_ID=1000244 */
        public static int VA009_EXECUTIONSTATUS_AD_Reference_ID = 1000244;/** Bounced = B */
...
@param VA009_ExecutionStatus Payment Execution Status */
        public void SetVA009_ExecutionStatus(String VA009_ExecutionStatus)
        {
            if (!IsVA009_ExecutionStatusValid(VA009_ExecutionStatus))
                throw new ArgumentException("VA009_ExecutionStatus Invalid value - " + VA009_ExecutionStatus + " - Reference_ID=1000244 - B - C - I - R"); if (VA009_ExecutionStatus != null && VA009_ExecutionStatus.Length > 1) { log.Warning("Length > 1 - truncated"); VA009_ExecutionStatus = VA009_ExecutionStatus.Substring(0, 1); } Set_Value("VA009_ExecutionStatus", VA009_ExecutionStatus);
        }/** Get Payment Execution Status.
@return Payment Execution Status */
        public String GetVA009_ExecutionStatus() { return (String)Get_Value("VA009_ExecutionStatus"); }/** Set Cancelled.
...
@return Cancelled */
        public Boolean IsVA009_IsCancelled() { Object oo = Get_Value("VA009_IsCancelled"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set Order Payment Schedule.
...
@return The way that a buyer choose to pay the seller of a good or service. */
        public int GetVA009_PaymentMethod_ID() { Object ii = Get_Value("VA009_PaymentMethod_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }/** Set Print Check.
...
@return Re-Print Check */
        public String GetVA009_RePrintCheck() { return (String)Get_Value("VA009_RePrintCheck"); }/** Set Interest Percentage.
@param VA026_Interest Interest Percentage */
        public void SetVA026_Interest(Decimal? VA026_Interest) { Set_Value("VA026_Interest", (Decimal?)VA026_Interest); }/** Get Interest Percentage.
@return Interest Percentage */
        public Decimal GetVA026_Interest() { Object bd = Get_Value("VA026_Interest"); if (bd == null) return Env.ZERO; return Convert.ToDecimal(bd); }/** Set Amount after Interest.
@param VA026_InterestAmt Amount after Interest      */
        public void SetVA026_InterestAmt(Decimal? VA026_InterestAmt) { Set_Value("VA026_InterestAmt", (Decimal?)VA026_InterestAmt); }/** Get Amount after Interest.
@return Amount after Interest      */
        public Decimal GetVA026_InterestAmt() { Object bd = Get_Value("VA026_InterestAmt"); if (bd == null) return Env.ZERO; return Convert.ToDecimal(bd); }/** Set Letter Of Credit.
@param VA026_LCDetail_ID Letter Of Credit   */
...
@return Letter Of Credit   */
        public int GetVA026_LCDetail_ID() { Object ii = Get_Value("VA026_LCDetail_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }/** Set TR Loan Application.
@param VA026_TRLoanApplication_ID TR Loan Application */
        public void SetVA026_TRLoanApplication_ID(int VA026_TRLoanApplication_ID)
        {
            if (VA026_TRLoanApplication_ID <= 0) Set_Value("VA026_TRLoanApplication_ID", null);
            else
                Set_Value("VA026_TRLoanApplication_ID", VA026_TRLoanApplication_ID);
        }/** Get TR Loan Application.
@return TR Loan Application */
        public int GetVA026_TRLoanApplication_ID() { Object ii = Get_Value("VA026_TRLoanApplication_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }/** Set Discounting PDC.
...
@return Post Dated Check */
        public int GetVA027_PostDatedCheck_ID() { Object ii = Get_Value("VA027_PostDatedCheck_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }/** Set IsPrinted.
...
@return IsPrinted */
        public Boolean IsVAAPBC_IsPrinted() { Object oo = Get_Value("VAAPBC_IsPrinted"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set Payment Voucher.
...
@return VSS_FEESTYPE */
        public String GetVSS_FEESTYPE() { return (String)Get_Value("VSS_FEESTYPE"); }/** Set VSS_RECEIPTNO.
@param VSS_RECEIPTNO VSS_RECEIPTNO */
        public void SetVSS_RECEIPTNO(String VSS_RECEIPTNO) { if (VSS_RECEIPTNO != null && VSS_RECEIPTNO.Length > 20) { log.Warning("Length > 20 - truncated"); VSS_RECEIPTNO = VSS_RECEIPTNO.Substring(0, 20); } Set_Value("VSS_RECEIPTNO", VSS_RECEIPTNO); }/** Get VSS_RECEIPTNO.
@return VSS_RECEIPTNO */
...
@return Amount to write-off */
        ...
        public void SetINT15_IsBounced(Boolean INT15_IsBounced) { Set_Value("INT15_IsBounced", INT15_IsBounced); }/** Get Bounced.
        @return Bounced */
        public Boolean IsINT15_IsBounced() { Object oo = Get_Value("INT15_IsBounced"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set Direct Payment.
        @param INT15_IsDirectPayment Direct Payment */
    }
}