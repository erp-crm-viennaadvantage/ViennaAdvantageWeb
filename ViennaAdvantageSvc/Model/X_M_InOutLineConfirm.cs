 ...
 *  @version Vienna Framework 1.1.1 - $Id$ */
    public class X_M_InOutLineConfirm : PO
    {
        ...
        */
        ...
        /** Set Item Code.@param GOM01_ItemCode Item Code */
        public void SetGOM01_ItemCode(String GOM01_ItemCode) { if (GOM01_ItemCode != null && GOM01_ItemCode.Length > 22) { log.Warning("Length > 22 - truncated"); GOM01_ItemCode = GOM01_ItemCode.Substring(0, 22); } Set_Value("GOM01_ItemCode", GOM01_ItemCode); }
        /** Get Item Code.@return Item Code */
        public String GetGOM01_ItemCode() { return (String)Get_Value("GOM01_ItemCode"); }
        /** Set Item Description.@param GOM01_ItemDescription Item Description */
        public void SetGOM01_ItemDescription(String GOM01_ItemDescription) { if (GOM01_ItemDescription != null && GOM01_ItemDescription.Length > 255) { log.Warning("Length > 255 - truncated"); GOM01_ItemDescription = GOM01_ItemDescription.Substring(0, 255); } Set_Value("GOM01_ItemDescription", GOM01_ItemDescription); } 
        /** Get Item Description.@return Item Description */
        public String GetGOM01_ItemDescription() { return (String)Get_Value("GOM01_ItemDescription"); }
        /** Set Item Name.@param GOM01_ItemName Item Name */
        public void SetGOM01_ItemName(String GOM01_ItemName) { if (GOM01_ItemName != null && GOM01_ItemName.Length > 255) { log.Warning("Length > 255 - truncated"); GOM01_ItemName = GOM01_ItemName.Substring(0, 255); } Set_Value("GOM01_ItemName", GOM01_ItemName); }
        /** Get Item Name.@return Item Name */
        public String GetGOM01_ItemName() { return (String)Get_Value("GOM01_ItemName"); }
    }
