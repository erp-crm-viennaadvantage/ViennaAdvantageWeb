...
public Boolean IsReversed() { Object oo = Get_Value("IsReversed"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }
        public void SetGOM01_IsRecordAvail(Boolean GOM01_IsRecordAvail) { Set_Value("GOM01_IsRecordAvail", GOM01_IsRecordAvail); }/** Get IsRecordAvail.
@return IsRecordAvail */
        public Boolean IsGOM01_IsRecordAvail() { Object oo = Get_Value("GOM01_IsRecordAvail"); if (oo != null) { if (oo.GetType() == typeof(bool)) return Convert.ToBoolean(oo); return "Y".Equals(oo); } return false; }/** Set InTime.
