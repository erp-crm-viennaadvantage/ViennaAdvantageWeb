...
@return Recognized Amount */
        ...
        /** Set INT15_RevenueService_ID.
@param INT15_RevenueService_ID INT15_RevenueService_ID */
        public void SetINT15_RevenueService_ID(int INT15_RevenueService_ID)
        {
            if (INT15_RevenueService_ID <= 0) Set_Value("INT15_RevenueService_ID", null);
            else
                Set_Value("INT15_RevenueService_ID", INT15_RevenueService_ID);
        }/** Get INT15_RevenueService_ID.
@return INT15_RevenueService_ID */
        public int GetINT15_RevenueService_ID() { Object ii = Get_Value("INT15_RevenueService_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }

        /** Set Recognition Date.
@param INT15_RecognitionDate Recognition Date */
        public void SetINT15_RecognitionDate(DateTime? INT15_RecognitionDate) { Set_Value("INT15_RecognitionDate", (DateTime?)INT15_RecognitionDate); }/** Get Recognition Date.
@return Recognition Date */
        public DateTime? GetINT15_RecognitionDate() { return (DateTime?)Get_Value("INT15_RecognitionDate"); }
    }
