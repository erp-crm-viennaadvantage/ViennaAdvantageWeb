namespace ViennaAdvantage.Model
{
    ...
    public class X_M_Movement : PO
    {
        ...
        */
        ...
        /** Set Charge.@param C_Charge_ID Additional document charges */
        ...
        /** Get Charge.@return Additional document charges */
        public int GetC_Charge_ID() { Object ii = Get_Value("C_Charge_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }

        /** Set GOM01_ChargeAmt.@param GOM01_ChargeAmt GOM01_ChargeAmt */
        public void SetGOM01_ChargeAmt(Decimal? GOM01_ChargeAmt) { Set_Value("GOM01_ChargeAmt", (Decimal?)GOM01_ChargeAmt); }
        /** Get GOM01_ChargeAmt. @return GOM01_ChargeAmt */
        public Decimal GetGOM01_ChargeAmt() { Object bd = Get_Value("GOM01_ChargeAmt"); if (bd == null) return Env.ZERO; return Convert.ToDecimal(bd); }

        /** Set Currency Type.@param C_ConversionType_ID Currency Conversion Rate Type */
        ...
        /** Get Currency Type.@return Currency Conversion Rate Type */
        public int GetC_ConversionType_ID() { Object ii = Get_Value("C_ConversionType_ID"); if (ii == null) return 0; return Convert.ToInt32(ii); }

        /** Set Currency.@param C_Currency_ID The Currency for this record */
        ...
        /** Get Currency.@return The Currency for this record */
