namespace ViennaAdvantage.Model
{
    ...
    public class X_C_Invoice : PO
    {
        ...
        */
        ...
        {
            if (POReference != null && POReference.Length > 100)
            {
                log.Warning("Length > 100 - truncated");
                POReference = POReference.Substring(0, 100);
            }
        ...
        {
            return test.Equals("B") || test.Equals("D") || test.Equals("K") || test.Equals("L") || test.Equals("P") || test.Equals("S") || test.Equals("T");
        }
        /** Set Payment Method.
...
@param VA009_PaymentMethod_ID Payment Method */
        ...
        public static int PAYMENTMETHOD_AD_Reference_ID = 195;
        /** Cash = B */
        public static String PAYMENTMETHOD_Cash = "B";
        /** Direct Debit = D */
        public static String PAYMENTMETHOD_DirectDebit = "D";
        /** Credit Card = K */
        public static String PAYMENTMETHOD_CreditCard = "K";
        /** Letter of Credit = L */
        public static String PAYMENTMETHOD_LetterOfCredit = "L";
        /** On Credit = P */
        public static String PAYMENTMETHOD_OnCredit = "P";
        /** Check = S */
        public static String PAYMENTMETHOD_Check = "S";
        /** Direct Deposit = T */
        public static String PAYMENTMETHOD_DirectDeposit = "T";
        /** Is test a valid value.
@param test testvalue@returns true if valid **/
        public bool IsPaymentMethodValid(String test) { return test == null || test.Equals("B") || test.Equals("D") || test.Equals("K") || test.Equals("L") || test.Equals("P") || test.Equals("S") || test.Equals("T"); }/** Set Payment Method.
@param PaymentMethod Payment Method */
        public void SetPaymentMethod(String PaymentMethod)
        {
            if (!IsPaymentMethodValid(PaymentMethod))
                throw new ArgumentException("PaymentMethod Invalid value - " + PaymentMethod + " - Reference_ID=195 - B - D - K - L - P - S - T"); if (PaymentMethod != null && PaymentMethod.Length > 1) { log.Warning("Length > 1 - truncated"); PaymentMethod = PaymentMethod.Substring(0, 1); } Set_Value("PaymentMethod", PaymentMethod);
        }
        /** Get Payment Method.@return Payment Method */
