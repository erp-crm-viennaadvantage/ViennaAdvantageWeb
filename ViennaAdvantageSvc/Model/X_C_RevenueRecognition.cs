 ...
 *  @version Vienna Framework 1.1.1 - $Id$ */
    ...
    {
        public X_C_RevenueRecognition(Context ctx, int C_RevenueRecognition_ID, Trx trxName)
        ...
        public X_C_RevenueRecognition(Ctx ctx, int C_RevenueRecognition_ID, Trx trxName)
            : base(ctx, C_RevenueRecognition_ID, trxName)
        {/** if (C_RevenueRecognition_ID == 0){SetC_RevenueRecognition_ID (0);SetIsTimeBased (false);SetName (null);} */
        }/** Load Constructor 
@param ctx context
...
*/
 ...
 added by ->Harwinder */
        ...
        static long serialVersionUID = 27825012524157L;/** Last Updated Timestamp 11/22/2018 3:46:47 PM */
        public static long updatedMS = 1542887207368L;/** AD_Table_ID=336 */
...
@return Export */
        ...
        /** INT15_RecognizeType AD_Reference_ID=1000299 */
        public static int INT15_RECOGNIZETYPE_AD_Reference_ID = 1000299;/** Expense = E */
        public static String INT15_RECOGNIZETYPE_Expense = "E";/** Revenue = R */
        public static String INT15_RECOGNIZETYPE_Revenue = "R";/** Is test a valid value.
@param test testvalue
@returns true if valid **/
        public bool IsINT15_RecognizeTypeValid(String test) { return test == null || test.Equals("E") || test.Equals("R"); }/** Set Recognize Type.
@param INT15_RecognizeType Recognize Type */
        public void SetINT15_RecognizeType(String INT15_RecognizeType)
        {
            if (!IsINT15_RecognizeTypeValid(INT15_RecognizeType))
                throw new ArgumentException("INT15_RecognizeType Invalid value - " + INT15_RecognizeType + " - Reference_ID=1000299 - E - R"); if (INT15_RecognizeType != null && INT15_RecognizeType.Length > 1) { log.Warning("Length > 1 - truncated"); INT15_RecognizeType = INT15_RecognizeType.Substring(0, 1); } Set_Value("INT15_RecognizeType", INT15_RecognizeType);
        }/** Get Recognize Type.
@return Recognize Type */
        public String GetINT15_RecognizeType() { return (String)Get_Value("INT15_RecognizeType"); }/** Set Time based.
...
@return Number of Months */
        ...
        public static int RECOGNITIONFREQUENCY_AD_Reference_ID = 196;/** Month = M */
...
@param test testvalue
@returns true if valid **/
        public bool IsRecognitionFrequencyValid(String test) { return test == null || test.Equals("M") || test.Equals("Q") || test.Equals("Y"); }/** Set Recognition frequency.
@param RecognitionFrequency Recognition frequency */
        public void SetRecognitionFrequency(String RecognitionFrequency)
        {
            if (!IsRecognitionFrequencyValid(RecognitionFrequency))
                throw new ArgumentException("RecognitionFrequency Invalid value - " + RecognitionFrequency + " - Reference_ID=196 - M - Q - Y"); if (RecognitionFrequency != null && RecognitionFrequency.Length > 1) { log.Warning("Length > 1 - truncated"); RecognitionFrequency = RecognitionFrequency.Substring(0, 1); } Set_Value("RecognitionFrequency", RecognitionFrequency);
