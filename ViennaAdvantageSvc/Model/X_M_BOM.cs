namespace ViennaAdvantage.Model
{
    ...
    public class X_M_BOM : PO
    {
        ...
        */
        ...
        /** Set Priority.
        @param GOM01_Priority Priority */
        public void SetGOM01_Priority(String GOM01_Priority) { if (GOM01_Priority != null && GOM01_Priority.Length > 20) { log.Warning("Length > 20 - truncated"); GOM01_Priority = GOM01_Priority.Substring(0, 20); } Set_Value("GOM01_Priority", GOM01_Priority); }/** Get Priority.
        @return Priority */
        public String GetGOM01_Priority() { return (String)Get_Value("GOM01_Priority"); }
    }
