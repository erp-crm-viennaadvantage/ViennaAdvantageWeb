...
using VAdvantage.ProcessEngine;namespace VAdvantage.Process
{
    public class InOutCreateConfirm : ProcessEngine.SvrProcess
    {
        ...
        protected override String DoIt()
        {
            ...
            ViennaAdvantage.Model.MInOut shipment = new ViennaAdvantage.Model.MInOut(GetCtx(), _M_InOut_ID, null);
            if (shipment.Get_ID() == 0)
            {
                throw new ArgumentException("Not found M_InOut_ID=" + _M_InOut_ID);
            }
            //
            ViennaAdvantage.Model.MInOutConfirm confirm = ViennaAdvantage.Model.MInOutConfirm.Create(shipment, _ConfirmType, true);
            if (confirm == null)
            {
