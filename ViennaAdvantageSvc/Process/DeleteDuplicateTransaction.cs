    ...
    public class DeleteDuplicateTransaction : SvrProcess
    {
        ...
        protected override string DoIt()
        {
            sql = @"SELECT   AD_Org_ID ,   M_Product_ID ,  M_Locator_ID ,  M_AttributeSetInstance_ID ,  m_movementline_id , m_transaction_id
                    FROM m_transaction WHERE m_product_id=" + M_Product_ID + " ORDER BY m_product_id";
            ...
            sql = @"SELECT COUNT(*) ,   AD_Org_ID ,   M_Product_ID ,  M_Locator_ID ,  M_AttributeSetInstance_ID
                    FROM m_transaction Where m_product_id=" + M_Product_ID + @"
                    GROUP BY AD_Org_ID ,   M_Product_ID ,  M_Locator_ID ,  M_AttributeSetInstance_ID
